...
@section('breadcrumbs')
    {{ Breadcrumbs::render('administrar-recurso.edit', $recurso) }}
@endsection
        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {!! Form::open(['route' => ['administrar-recurso.update', $recurso->id]]) !!}
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="cidade_id" class="form-control {{ $errors->first('cidade_id') ? 'is-invalid' : ''}}" id="cidade">
                                    ...
                                    @foreach($cidades as $cidade)
                                        <option value="{{ $cidade->id }}" {{ ($recurso->cidade->id == $cidade->id) ? 'selected' : '' }}>{{ $cidade->nome }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="orgao_id" class="form-control {{ $errors->first('orgao_id') ? 'is-invalid' : ''}}" id="orgao">
                                    ...
                                    @foreach($orgaos as $orgao)
                                        <option value="{{ $orgao->id }}" {{ ($recurso->orgao->id == $orgao->id) ? 'selected' : '' }}>{{ $orgao->nome }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                {!! Form::text('acao', $recurso->acao, ['class' => ($errors->first('acao')) ? 'form-control is-invalid' : 'form-control', 'placeholder' => 'Ex.: Reforma na sala de aula']) !!}
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                {!! Form::text('instituicao', $recurso->instituicao, ['class' => ($errors->first('instituicao')) ? 'form-control is-invalid' : 'form-control', 'placeholder' => 'Ex.: Escola da reforma']) !!}
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                            <div class="form-group">
                                ...
                                {!! Form::text('ano', $recurso->ano, ['class' => ($errors->first('ano')) ? 'form-control is-invalid' : 'form-control', 'placeholder' => 'Ex.: 2018']) !!}
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                            <div class="form-group">
                                ...
                                {!! Form::text('processo', $recurso->processo, ['class' => ($errors->first('processo')) ? 'form-control is-invalid' : 'form-control', 'placeholder' => 'Ex.: 00000000']) !!}
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                            <div class="form-group">
                                ...
                                {!! Form::text('situacao', $recurso->situacao, ['class' => ($errors->first('situacao')) ? 'form-control is-invalid' : 'form-control', 'placeholder' => 'Ex.: Aprovado']) !!}
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                            <div class="form-group">
                                ...
                                {!! Form::text('valor', number_format($recurso->valor, 2, ',', '.'), ['class' => ($errors->first('valor')) ? 'form-control real is-invalid' : 'form-control real', 'placeholder' => 'Ex.: 500,00']) !!}
