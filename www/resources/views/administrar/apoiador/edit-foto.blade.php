...
@section('breadcrumbs')
    {{ Breadcrumbs::render('administrar-apoiador.editFoto', $apoiador) }}
@endsection
...
@section('content')
    ...
    {!! Form::open(['route' => ['administrar-apoiador.updateFoto', $apoiador->id ], 'enctype' => 'multipart/form-data']) !!}
    <div class="card">
        <div class="card-header bg-secondary text-center text-white">
            Editar Foto de {{ $apoiador->nome }}
        </div>
        <div class="card-body">
            <div class="row">
            ...
            <div class="row mt-3">
                <div class="col-12 col-sm-12 offset-md-4 col-md-4 offset-lg-4 col-lg-4">
                    <div class="form-group">
                        {!! Form::label('foto', 'Escolha a nova foto de ' . $apoiador->nome, ['class' => 'control-label']) !!}
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col-12 col-sm-12 offset-md-4 col-md-4 offset-lg-4 col-lg-4 text-center">
                    <div class="row">
                        <div class="col-6">
                            <a href="{{ route('administrar-apoiador.edit', $apoiador->id) }}" class="btn btn-outline-secondary btn-block">Voltar</a>
                        </div>
                        <div class="col-6">
